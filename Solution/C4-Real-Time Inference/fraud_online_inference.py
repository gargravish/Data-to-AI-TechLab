...
# Configuration
PROJECT_ID = ""
SUBSCRIPTION_PATH = "projects//subscriptions/ff-tx-sub"
    ...
    def get_features(self, transaction_data):
        ...
        terminal_features AS (
            SELECT
                ...
                terminal_id_risk_15min_window,
                terminal_id_nb_tx_30min_window,
                terminal_id_risk_30min_window,                
                terminal_id_nb_tx_60min_window,
                terminal_id_risk_60min_window,
        ...
        SELECT
            ...
            COALESCE(t.terminal_id_nb_tx_15min_window, 0) as terminal_id_nb_tx_15min_window,
            COALESCE(t.terminal_id_risk_15min_window, 0) as terminal_id_risk_15min_window,
            COALESCE(t.terminal_id_nb_tx_30min_window, 0) as terminal_id_nb_tx_30min_window,
            COALESCE(t.terminal_id_risk_30min_window, 0) as terminal_id_risk_30min_window,                        
            COALESCE(t.terminal_id_nb_tx_60min_window, 0) as terminal_id_nb_tx_60min_window,
            COALESCE(t.terminal_id_risk_60min_window, 0) as terminal_id_risk_60min_window,
